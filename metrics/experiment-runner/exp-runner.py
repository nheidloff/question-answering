...
def add_qa_service_metrics_to_excel(qa_metrics_run_file, workbook_name_file, str_rouge):
        ...
        for row in metrics_results:
                ...
                worksheet.cell(row=(j+1), column=16).value = row[12]
                worksheet.cell(row=(j+1), column=17).value = row[13]
                worksheet.cell(row=(j+1), column=18).value = row[14]
                worksheet.cell(row=(j+1), column=19).value = row[15]
                worksheet.cell(row=(j+1), column=20).value = row[16]
                worksheet.cell(row=(j+1), column=21).value = row[17]
                j = j + 1
