...
# Question Answering CE application env variables configuration
...
export EXPERIMENT_LLM_NAME="goole/ul2"
export EXPERIMENT_LLM_MIN_NEW_TOKENS=5
export EXPERIMENT_LLM_MAX_NEW_TOKENS=25
export EXPERIMENT_LLM_MAX_INPUT_DOCUMENTS=5
export EXPERIMENT_RERANKER_MAX_INPUT_DOCUMENTS=10
export EXPERIMENT_METRICS_DIRECTORY=$(pwd)/../metrics/myrun
export EXPERIMENT_METRICS_RUN="EX1_RUN_1"
